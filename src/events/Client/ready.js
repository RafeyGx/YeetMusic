...
module.exports = {
	name: "ready",
	run: async (client) => {
		const readylogs = new WebhookClient({ url: "https://discord.com/api/webhooks/1073585676961980538/1bS1kYVp6y4jCK1_SpQgHOWI4ECJMwjf0HM0D2UTa8f8dL_YiGxjBPw0zmgTHFr48VVB" })
